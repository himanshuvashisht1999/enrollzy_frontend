...
<div style="background-color: #f9f9f9; padding: 20px 0 60px 0;">
    <div class="container">
        ...
        @php
            $hasBadges = $filteredPage->ownership_type || $filteredPage->curriculum || $filteredPage->university_type || $filteredPage->degree || $filteredPage->state || $filteredPage->city || $filteredPage->coaching_category_id || !empty($filteredPage->course_id);
        @endphp
        
        @if($hasBadges)
        <div class="mb-4 text-center">
            <div class="d-flex justify-content-center gap-2 flex-wrap mt-2">
                @if(isset($filteredPage->course_name)) <span class="badge" style="background: #059669; font-size: 14px; padding: 8px 15px;">Course: {{ $filteredPage->course_name }}</span> @endif
